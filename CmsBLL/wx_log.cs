...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.wx_log dal=new SQLServerDAL.wx_log();
		public wx_log()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.wx_log GetModelByCache(int id)
		{
			
			string CacheKey = "wx_logModel-" + id;
			...
			return (Cms.Model.wx_log)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_log> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_log> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_log> modelList = new List<Cms.Model.wx_log>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_log model;
