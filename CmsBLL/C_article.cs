...
namespace Cms.BLL
{
	...
	{
        private readonly Cms.SQLServerDAL.C_article dal = new Cms.SQLServerDAL.C_article();
		public C_article()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article GetModelByCache(int articleId)
		{
			
			string CacheKey = "C_articleModel-" + articleId;
			...
			return (Cms.Model.C_article)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article> modelList = new List<Cms.Model.C_article>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article model;
