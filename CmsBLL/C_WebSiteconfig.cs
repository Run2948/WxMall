...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_WebSiteconfig dal=new Cms.DAL.C_WebSiteconfig();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_WebSiteconfig GetModelByCache(int siteid)
		{
			
			string CacheKey = "C_WebSiteconfigModel-" + siteid;
			...
			return (Cms.Model.C_WebSiteconfig)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_WebSiteconfig> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_WebSiteconfig> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_WebSiteconfig> modelList = new List<Cms.Model.C_WebSiteconfig>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_WebSiteconfig model;
