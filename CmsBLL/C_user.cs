...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_user dal=new SQLServerDAL.C_user();
		public C_user()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_user GetModelByCache(int id)
		{
			
			string CacheKey = "C_userModel-" + id;
			...
			return (Cms.Model.C_user)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_user> modelList = new List<Cms.Model.C_user>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_user model;
