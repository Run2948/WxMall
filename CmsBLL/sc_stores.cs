...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.sc_stores dal=new Cms.DAL.sc_stores();
		public sc_stores()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.sc_stores GetModelByCache(int id)
		{
			
			string CacheKey = "sc_storesModel-" + id;
			...
			return (Cms.Model.sc_stores)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.sc_stores> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.sc_stores> DataTableToList(DataTable dt)
		{
			List<Cms.Model.sc_stores> modelList = new List<Cms.Model.sc_stores>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.sc_stores model;
