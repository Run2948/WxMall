...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_article_comment dal=new SQLServerDAL.C_article_comment();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article_comment GetModelByCache(int id)
		{
			
			string CacheKey = "C_article_commentModel-" + id;
			...
			return (Cms.Model.C_article_comment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_comment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_comment> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article_comment> modelList = new List<Cms.Model.C_article_comment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article_comment model;
