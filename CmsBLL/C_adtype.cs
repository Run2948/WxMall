...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_adtype dal=new SQLServerDAL.C_adtype();
		public C_adtype()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_adtype GetModelByCache(int id)
		{
			
			string CacheKey = "C_adtypeModel-" + id;
			...
			return (Cms.Model.C_adtype)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_adtype> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_adtype> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_adtype> modelList = new List<Cms.Model.C_adtype>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_adtype model;
