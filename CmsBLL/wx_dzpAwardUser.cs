...
namespace Cms.BLL
{
	...
	{
        private readonly Cms.SQLServerDAL.wx_dzpAwardUser dal = new Cms.SQLServerDAL.wx_dzpAwardUser();
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpAwardUser> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpAwardUser> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_dzpAwardUser> modelList = new List<Cms.Model.wx_dzpAwardUser>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_dzpAwardUser model;
        ...
        {
            Cms.Model.wx_dzpAwardUser auser = new Model.wx_dzpAwardUser();
            auser.actId = aid;
        ...
        /// 获得中奖的数据列表
        /// </summary>
        public List<Cms.Model.wx_dzpAwardUser> getHasZJList(int aid)
        {
