...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_link dal=new SQLServerDAL.C_link();
		public C_link()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_link GetModelByCache(int id)
		{
			
			string CacheKey = "C_linkModel-" + id;
			...
			return (Cms.Model.C_link)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_link> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_link> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_link> modelList = new List<Cms.Model.C_link>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_link model;
