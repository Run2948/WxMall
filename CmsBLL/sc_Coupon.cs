...
namespace Cms.BLL
{
	...
	{
        private readonly Cms.DAL.sc_Coupon dal = new Cms.DAL.sc_Coupon();
		public sc_Coupon()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.sc_Coupon GetModelByCache(int id)
		{
			
			string CacheKey = "sc_CouponModel-" + id;
			...
			return (Cms.Model.sc_Coupon)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.sc_Coupon> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.sc_Coupon> DataTableToList(DataTable dt)
		{
			List<Cms.Model.sc_Coupon> modelList = new List<Cms.Model.sc_Coupon>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.sc_Coupon model;
