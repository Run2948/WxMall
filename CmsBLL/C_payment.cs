...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_payment dal=new SQLServerDAL.C_payment();
		public C_payment()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_payment GetModelByCache(int id)
		{
			
			string CacheKey = "C_paymentModel-" + id;
			...
			return (Cms.Model.C_payment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_payment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_payment> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_payment> modelList = new List<Cms.Model.C_payment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_payment model;
