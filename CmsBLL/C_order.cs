...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_order dal=new Cms.DAL.C_order();
		public C_order()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_order GetModelByCache(int id)
		{
			
			string CacheKey = "C_orderModel-" + id;
			...
			return (Cms.Model.C_order)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_order> modelList = new List<Cms.Model.C_order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_order model;
