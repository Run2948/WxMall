...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_Column dal=new SQLServerDAL.C_Column();
		public C_Column()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_Column GetModelByCache(int classId)
		{
			
			string CacheKey = "C_ColumnModel-" + classId;
			...
			return (Cms.Model.C_Column)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_Column> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_Column> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_Column> modelList = new List<Cms.Model.C_Column>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_Column model;
