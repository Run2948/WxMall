...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.wx_dzpActionInfo dal = new SQLServerDAL.wx_dzpActionInfo();
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpActionInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpActionInfo> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_dzpActionInfo> modelList = new List<Cms.Model.wx_dzpActionInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_dzpActionInfo model;
