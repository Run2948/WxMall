...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.c_product_albums dal=new Cms.DAL.c_product_albums();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.c_product_albums GetModelByCache(int id)
		{
			
			string CacheKey = "c_product_albumsModel-" + id;
			...
			return (Cms.Model.c_product_albums)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.c_product_albums> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.c_product_albums> DataTableToList(DataTable dt)
		{
			List<Cms.Model.c_product_albums> modelList = new List<Cms.Model.c_product_albums>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.c_product_albums model;
