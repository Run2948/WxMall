...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.wx_menu dal=new SQLServerDAL.wx_menu();
		public wx_menu()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.wx_menu GetModelByCache(int id)
		{
			
			string CacheKey = "wx_menuModel-" + id;
			...
			return (Cms.Model.wx_menu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_menu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_menu> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_menu> modelList = new List<Cms.Model.wx_menu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_menu model;
