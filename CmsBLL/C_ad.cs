...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_ad dal=new SQLServerDAL.C_ad();
		public C_ad()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_ad GetModelByCache(int id)
		{
			
			string CacheKey = "C_adModel-" + id;
			...
			return (Cms.Model.C_ad)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_ad> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_ad> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_ad> modelList = new List<Cms.Model.C_ad>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_ad model;
