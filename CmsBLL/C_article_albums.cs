...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_article_albums dal=new SQLServerDAL.C_article_albums();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article_albums GetModelByCache(int id)
		{
			
			string CacheKey = "C_article_albumsModel-" + id;
			...
			return (Cms.Model.C_article_albums)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_albums> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_albums> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article_albums> modelList = new List<Cms.Model.C_article_albums>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article_albums model;
