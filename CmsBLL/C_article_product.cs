...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_article_product dal=new Cms.DAL.C_article_product();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article_product GetModelByCache(int id)
		{
			
			string CacheKey = "C_article_productModel-" + id;
			...
			return (Cms.Model.C_article_product)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_product> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article_product> modelList = new List<Cms.Model.C_article_product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article_product model;
