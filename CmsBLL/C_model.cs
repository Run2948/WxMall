...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_model dal=new SQLServerDAL.C_model();
		public C_model()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_model GetModelByCache(int modelId)
		{
			
			string CacheKey = "C_modelModel-" + modelId;
			...
			return (Cms.Model.C_model)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_model> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_model> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_model> modelList = new List<Cms.Model.C_model>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_model model;
