...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.SQLServerDAL.wx_dzpUsersTemp dal=new Cms.SQLServerDAL.wx_dzpUsersTemp();
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpUsersTemp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_dzpUsersTemp> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_dzpUsersTemp> modelList = new List<Cms.Model.wx_dzpUsersTemp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_dzpUsersTemp model;
