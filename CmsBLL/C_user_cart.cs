...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_user_cart dal=new Cms.DAL.C_user_cart();
		public C_user_cart()
		{}
		#region  BasicMethod
        ...
        {
            return dal.Exists(article_id, user_id, typeId);
        }
		/// <summary>
		/// 增加一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_user_cart GetModelByCache(int id)
		{
			
			string CacheKey = "C_user_cartModel-" + id;
			...
			return (Cms.Model.C_user_cart)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_cart> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_cart> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_user_cart> modelList = new List<Cms.Model.C_user_cart>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_user_cart model;
