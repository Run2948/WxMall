...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_user_coupon dal=new Cms.DAL.C_user_coupon();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_user_coupon GetModelByCache(int id)
		{
			
			string CacheKey = "C_user_couponModel-" + id;
			...
			return (Cms.Model.C_user_coupon)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_coupon> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_coupon> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_user_coupon> modelList = new List<Cms.Model.C_user_coupon>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_user_coupon model;
