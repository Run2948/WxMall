...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_message dal=new SQLServerDAL.C_message();
		public C_message()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_message GetModelByCache(int messageid)
		{
			
			string CacheKey = "C_messageModel-" + messageid;
			...
			return (Cms.Model.C_message)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_message> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_message> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_message> modelList = new List<Cms.Model.C_message>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_message model;
