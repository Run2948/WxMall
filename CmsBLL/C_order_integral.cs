...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_order_integral dal=new Cms.DAL.C_order_integral();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_order_integral GetModelByCache(int id)
		{
			
			string CacheKey = "C_order_integralModel-" + id;
			...
			return (Cms.Model.C_order_integral)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order_integral> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order_integral> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_order_integral> modelList = new List<Cms.Model.C_order_integral>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_order_integral model;
