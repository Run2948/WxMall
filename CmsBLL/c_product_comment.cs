...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.c_product_comment dal=new Cms.DAL.c_product_comment();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.c_product_comment GetModelByCache(int id)
		{
			
			string CacheKey = "c_product_commentModel-" + id;
			...
			return (Cms.Model.c_product_comment)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.c_product_comment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.c_product_comment> DataTableToList(DataTable dt)
		{
			List<Cms.Model.c_product_comment> modelList = new List<Cms.Model.c_product_comment>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.c_product_comment model;
