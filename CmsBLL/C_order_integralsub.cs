...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_order_integralsub dal=new SQLServerDAL.C_order_integralsub();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_order_integralsub GetModelByCache(int id)
		{
			
			string CacheKey = "C_order_integralsubModel-" + id;
			...
			return (Cms.Model.C_order_integralsub)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order_integralsub> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_order_integralsub> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_order_integralsub> modelList = new List<Cms.Model.C_order_integralsub>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_order_integralsub model;
