...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_article_attach dal=new SQLServerDAL.C_article_attach();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article_attach GetModelByCache(int id)
		{
			
			string CacheKey = "C_article_attachModel-" + id;
			...
			return (Cms.Model.C_article_attach)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_attach> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_attach> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article_attach> modelList = new List<Cms.Model.C_article_attach>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article_attach model;
