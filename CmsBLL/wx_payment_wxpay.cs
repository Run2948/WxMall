...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.wx_payment_wxpay dal=new SQLServerDAL.wx_payment_wxpay();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.wx_payment_wxpay GetModelByCache(int id)
		{
			
			string CacheKey = "wx_payment_wxpayModel-" + id;
			...
			return (Cms.Model.wx_payment_wxpay)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_payment_wxpay> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.wx_payment_wxpay> DataTableToList(DataTable dt)
		{
			List<Cms.Model.wx_payment_wxpay> modelList = new List<Cms.Model.wx_payment_wxpay>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.wx_payment_wxpay model;
