...
namespace Cms.BLL
{
	...
	{
		private readonly Cms.DAL.C_user_recharge dal=new Cms.DAL.C_user_recharge();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_user_recharge GetModelByCache(int id)
		{
			
			string CacheKey = "C_user_rechargeModel-" + id;
			...
			return (Cms.Model.C_user_recharge)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_recharge> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_recharge> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_user_recharge> modelList = new List<Cms.Model.C_user_recharge>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_user_recharge model;
