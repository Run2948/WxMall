...
namespace Cms.BLL
{
	...
	{
        private readonly SQLServerDAL.C_user_oauth_app dal=new SQLServerDAL.C_user_oauth_app();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_user_oauth_app GetModelByCache(int id)
		{
			
			string CacheKey = "C_user_oauth_appModel-" + id;
			...
			return (Cms.Model.C_user_oauth_app)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_oauth_app> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_user_oauth_app> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_user_oauth_app> modelList = new List<Cms.Model.C_user_oauth_app>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_user_oauth_app model;
