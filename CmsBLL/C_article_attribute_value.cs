...
{
	/// <summary>
	/// C_article_attribute_value
	/// </summary>
	public partial class C_article_attribute_value
	{
        private readonly SQLServerDAL.C_article_attribute_value dal=new SQLServerDAL.C_article_attribute_value();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cms.Model.C_article_attribute_value GetModelByCache(int article_id)
		{
			
			string CacheKey = "C_article_attribute_valueModel-" + article_id;
			...
			return (Cms.Model.C_article_attribute_value)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_attribute_value> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cms.Model.C_article_attribute_value> DataTableToList(DataTable dt)
		{
			List<Cms.Model.C_article_attribute_value> modelList = new List<Cms.Model.C_article_attribute_value>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cms.Model.C_article_attribute_value model;
