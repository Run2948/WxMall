...
$(function(){
	...
	$(".rule-multi-radiocolor").ruleMultiRadiocolor();
	$(".rule-multi-radiocut").ruleMultiRadiocut();
	$(".rule-multi-radioclarity").ruleMultiRadioclarity();
	$(".rule-multi-radioshape").ruleMultiRadioshape();
	$(".rule-multi-radiomaterial").ruleMultiRadiomaterial();
	$(".rule-multi-radiobstype").ruleMultiRadiobstype();
	$(".rule-multi-radiopintype").ruleMultiRadiopintype();
...
function jsprintWeb(msgtitle, url, msgcss, callback) {
    var iconurl = "";
    switch (msgcss) {
        case "Success":
...
//多项颜色单选
$.fn.ruleMultiRadiocolor = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radiocolor"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='color']:checked").val();
                var strtwo = $("input[name='color']:eq(" + indexNum + ")").val();
                ...
                if (starone != strtwo) {
                    ...
                    $(this).removeClass("selected");
                    parentObj.find('input[type="radio"]').prop("checked", false);
                    parentObj.find('input[type="radio"]').eq(indexNum).prop("checked", false);
...
//多项切片单选
$.fn.ruleMultiRadiocut = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radiocut"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='cut']:checked").val();
                var strtwo = $("input[name='cut']:eq(" + indexNum + ")").val();
...
//多项切片单选
$.fn.ruleMultiRadioclarity = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radioclarity"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='clarity']:checked").val();
                var strtwo = $("input[name='clarity']:eq(" + indexNum + ")").val();
...
//多项钻石单选
$.fn.ruleMultiRadioshape = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radioshape"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='diamond_shape']:checked").val();
                var strtwo = $("input[name='diamond_shape']:eq(" + indexNum + ")").val();
...
//多项金属材质单选
$.fn.ruleMultiRadiomaterial = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radiomaterial"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='material']:checked").val();
                var strtwo = $("input[name='material']:eq(" + indexNum + ")").val();
...
//多项石类单选
$.fn.ruleMultiRadiobstype = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radiobstype"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='bstype']:checked").val();
                var strtwo = $("input[name='bstype']:eq(" + indexNum + ")").val();
...
//多项品类单选
$.fn.ruleMultiRadiopintype = function () {
    var multiRadio = function (parentObj) {
        parentObj.addClass("multi-radiopintype"); //添加样式
        parentObj.children().hide(); //隐藏内容
        var divObj = $('<div class="boxwrap"></div>').prependTo(parentObj); //前插入一个DIV
        parentObj.find('input[type="radio"]').each(function () {
            var indexNum = parentObj.find('input[type="radio"]').index(this); //当前索引
            ...
            //绑定事件
            $(newObj).click(function () {
                var starone = $("input[name='pintype']:checked").val();
                var strtwo = $("input[name='pintype']:eq(" + indexNum + ")").val();
