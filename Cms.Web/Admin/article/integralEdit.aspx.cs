...
public partial class Admin_article_integralEdit : System.Web.UI.Page
{
    ...
    public void DataBind(int articleId)
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            gold_price.Text = Convert.ToDecimal(dt.Rows[0]["gold_price"] ?? "0.00").ToString("0.00");
            labor_charges.Text = Convert.ToDecimal((string) dt.Rows[0]["labor_charges"] == "" ? "0.00" : dt.Rows[0]["labor_charges"]).ToString("0.00");
            ...
            sales_labor_charge.Text = Convert.ToDecimal((string) dt.Rows[0]["sales_labor_charge"] == "" ? "0.00" : dt.Rows[0]["sales_labor_charge"]).ToString("0.00");
            accessories_price.Text = Convert.ToDecimal((string) dt.Rows[0]["accessories_price"] == "" ? "0.00" : dt.Rows[0]["accessories_price"]).ToString("0.00");
