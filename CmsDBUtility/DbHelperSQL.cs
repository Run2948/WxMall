...
namespace Cms.DBUtility
{
    public abstract class DbHelperSQL
    {
        ...
        {
            SqlConnection OleDbDataConn = new SqlConnection(connectionString);
            SqlCommand OleDbComm = new SqlCommand(cmdText, OleDbDataConn);
            OleDbComm.CommandType = cmdType;
            SqlDataAdapter OleDbDA = new SqlDataAdapter(OleDbComm);
