...
namespace Cms.SQLServerDAL
{
	...
	public partial class wx_ggkUsersTemp
	{
		...
		public Cms.Model.wx_ggkUsersTemp GetModel(int id)
		{
			...
			Cms.Model.wx_ggkUsersTemp model=new Cms.Model.wx_ggkUsersTemp();
		...
		/// 得到一个对象实体
		/// </summary>
		public Cms.Model.wx_ggkUsersTemp DataRowToModel(DataRow row)
		{
			Cms.Model.wx_ggkUsersTemp model=new Cms.Model.wx_ggkUsersTemp();
			if (row != null)
			{
        ...
        /// 得到一个对象实体
        /// </summary>
        public Cms.Model.wx_ggkUsersTemp getModelByAidOpenid(int actId, string openid)
        {
