...
namespace Cms.SQLServerDAL
{
	...
	public partial class C_admin_role
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "C_admin_role"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from C_admin_role");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into C_admin_role(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update C_admin_role set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from C_admin_role ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Cms.Model.C_admin_role GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,role_name,role_type,is_sys from C_admin_role ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Cms.Model.C_admin_role DataRowToModel(DataRow row)
		{
			Cms.Model.C_admin_role model=new Cms.Model.C_admin_role();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM C_admin_role ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,role_name,role_type,is_sys ");
			strSql.Append(" FROM C_admin_role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from C_admin_role T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "C_admin_role";
