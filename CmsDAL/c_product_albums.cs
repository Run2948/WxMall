...
namespace Cms.DAL
{
	...
	public partial class c_product_albums
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "c_product_albums"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from c_product_albums");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from c_product_albums ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,productId,thumb_path,original_path,remark,add_time ");
			strSql.Append(" FROM c_product_albums ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,productId,thumb_path,original_path,remark,add_time ");
			strSql.Append(" FROM c_product_albums ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from c_product_albums T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "c_product_albums";
