...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2015/2/4 11:30:06   N/A    初版
*
...
{
	/// <summary>
	/// 数据访问类:C_exchange_cart
	/// </summary>
	public partial class C_exchange_cart
	{
		public C_exchange_cart()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "C_exchange_cart"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from C_exchange_cart");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from C_exchange_cart ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,article_id,title,price,quantity,integral,property_value,note,is_checked,updateTime ");
			strSql.Append(" FROM C_exchange_cart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,user_id,article_id,title,price,quantity,integral,property_value,note,is_checked,updateTime ");
			strSql.Append(" FROM C_exchange_cart ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from C_exchange_cart T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "C_exchange_cart";
