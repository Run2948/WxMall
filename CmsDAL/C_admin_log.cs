...
namespace Cms.SQLServerDAL
{
	...
	public partial class C_admin_log
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "C_admin_log"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from C_admin_log");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into C_admin_log(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update C_admin_log set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from C_admin_log ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Cms.Model.C_admin_log GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,user_id,user_name,action_type,remark,user_ip,add_time from C_admin_log ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Cms.Model.C_admin_log DataRowToModel(DataRow row)
		{
			Cms.Model.C_admin_log model=new Cms.Model.C_admin_log();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM C_admin_log ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from C_admin_log T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "C_admin_log";
