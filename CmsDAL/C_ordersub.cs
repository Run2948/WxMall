...
namespace Cms.SQLServerDAL
{
	...
	public partial class C_ordersub
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "C_ordersub"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from C_ordersub");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Cms.Model.C_ordersub model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into C_ordersub(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Cms.Model.C_ordersub model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update C_ordersub set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from C_ordersub ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Cms.Model.C_ordersub GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,user_id,order_id,order_num,article_id,title,price,quantity,integral,property_value,note,updateTime from C_ordersub ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Cms.Model.C_ordersub model=new Cms.Model.C_ordersub();
		...
		/// 得到一个对象实体
		/// </summary>
		public Cms.Model.C_ordersub DataRowToModel(DataRow row)
		{
			Cms.Model.C_ordersub model=new Cms.Model.C_ordersub();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from C_ordersub T ");
